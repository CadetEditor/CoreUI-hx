...
class InspectableObject extends EventDispatcher
{
	...
	private function set_Number2(value : Float) : Float
	{
		...
		_number2 = value;dispatchEvent(new PropertyChangeEvent("propertyChange_number2", oldValue, _number2));
        return value;
    }
	...
	{
		_color = value;dispatchEvent(new PropertyChangeEvent("propertyChange_color", null, _color));
        return value;
    }
}